...
| **Superstore Sales** | Retail sales and profit analysis to optimize discount and logistics strategy | • Data cleaning with Power Query (8 new columns)<br>• Data modeling with Power Pivot (5 tables, 38 DAX measures)<br>•<br>4 interactive Tableau dashboards (Executive, Product, Customer, Logistics)<br>• Discount ROI analysis & SLA compliance tracking |
